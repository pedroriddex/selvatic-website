...
export const getHomeHeroVideoPosterUrl = () => SITE_MEDIA.heroVideoPosterUrl;
...
export const getHomePromoImage = (products: Product[]) =>
	SITE_MEDIA.homePromoImageUrl || products[0]?.imageUrl;
